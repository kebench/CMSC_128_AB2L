...
class Controller_search_book extends CI_Controller {
	...
	public function get_book_data(){
		...
		$config['base_url'] = 'http://localhost/ics_library_ab2l/index.php/admin/controller_search_book/get_book_data';		//EDIT THIS BASE_URL IF YOU ARE USING A DIFFERENT URL. 
